...
{/* -------------------------------------------------------- */}
        ...
        <div className={`h-[500px] w-[500px] shadow-2xl bg-gray-100 rounded-2xl p-6 ${isLoading ? 'cursor-wait' : 'cursor-auto'}`}>
          {
            !showPayment ? (
              <>
                <h2 className='text-xl text-black mb-4 text-center'>Vos Informations</h2>
              ...
              <>
                <h2 className='text-xl text-black mb-4 text-center'>Sélectionnez votre moyen de paiement</h2>
                ...
                <div className='flex flex-col gap-4'>
                  {paymentMethods.map((method) => (
                    <button
                      ...
                      ${selectedMethod === method.id ? 'border-amber-500 bg-blue-50' : 'border-gray-300 hover:border-amber-300'}`}
                    >
