...
export default function Login() {
  ...
  return (
    <section className='w-auto mt-32 mb-18 flex flex-wrap flex-col'>
      ...
      <div className='h-auto mx-auto rounded-3xl flex flex-wrap'>
        <div className="w-full lg:w-[500px] h-[550px] shadow-2xl mx-auto rounded-br-3xl rounded-tr-3xl px-6 flex flex-col gap-8 border-l-black border-2">
        ...
        <div className="w-full lg:w-[500px] h-[550px] shadow-2xl mx-auto rounded-tl-3xl rounded-bl-3xl border-2 border-r-black px-6 flex flex-col gap-8">
